...
int main(void)
{
  ...
  10000, 10200};
  /*
  shiftLightsInit(&htim2, TIM_CHANNEL_3, ledcolors, ledbytes);
  lightOn(&htim2, TIM_CHANNEL_3, ledcolors, ledbytes, 0);
  lightOn(&htim2, TIM_CHANNEL_3, ledcolors, ledbytes, 1);
